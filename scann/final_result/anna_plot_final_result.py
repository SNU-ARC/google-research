...
1. lsens
(1) python3 anna_plot_final_result.py --program scann --dataset sift1m --metric squared_l2 --reorder -1 --topk 1000 --build_config --lsens 1000 2000 800 --m 32
(2) python3 anna_plot_final_result.py --program faissGPU --dataset music1m --metric dot_product --reorder -1 --topk 1000 --build_config --lsens 1000 2000 3000 4000 --kstar 256 --m 50 --target 1@100
(3 for all possible Ls) python3 anna_plot_final_result.py --program scann --dataset sift1m --metric squared_l2 --reorder -1 --topk 1000 --build_config --lsens 9999 --m 32 --target 100@1000
2. msens
(1) python3 anna_plot_final_result.py --program scann --dataset sift1m --metric squared_l2 --reorder -1 --topk 1000 --build_config --msens 64 32 --L 2000
(2) python3 anna_plot_final_result.py --program faissGPU --dataset music1m --metric dot_product --reorder -1 --topk 1000 --build_config --msens 20 25 --kstar 256 --L 2000
3. kstarsens
python3 anna_plot_final_result.py --program faiss --dataset deep1m --metric squared_l2 --reorder -1 --topk 1000 --build_config --kstarsens 256 128 64 32 --L 600 --m 128
'''
import os
...
from anna_plot_util_final_result import *
        ...
        for i, line in enumerate(lines):
            ...
            if i==0:
                ...
                if args.target == "1":
                    ...
                    acc.append(float(result[9]))
                elif args.target == "1@100":
                    acc.append(float(result[11]))
                elif args.target == "10@100":
                    acc.append(float(result[13]))
                elif args.target == "1@1000":
                    acc.append(float(result[15]))
                elif args.target == "10@1000":
                    acc.append(float(result[17]))
                elif args.target == "100@1000":
                    acc.append(float(result[19]))
