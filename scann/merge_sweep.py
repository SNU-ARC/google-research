...
recall_file_location = "/arc-share/MICRO21_ANNA/merge_sweep/google-research/scann/final_result/"
recall_file_name = str(args.program)+"_"+str(args.dataset)+"_topk_1000"+"_num_split_"+(str(20) if args.dataset == "sift1b" or args.dataset == "deep1b" else str(1))+"_batch_128_"+str(args.metric)+"_reorder_-1_sweep_result_use_only_recalls.txt"
...
def parse_even_lines_recall(line):
	...
	return top1, top10, top100, top1000, top1_10, top1_100, top10_100, top1_1000, top10_1000, top100_1000
...
for line in recall_read_lines:
	...
	if recall_read_line_number == 1 or recall_read_line_number == 2:
		...
		top1, top10, top100, top1000, top1_10, top1_100, top10_100, top1_1000, top10_1000, top100_1000 = parse_even_lines_recall(line)
		default_latency = -1
...
latency_file_location = "./result/"
latency_file_name = str(args.program)+"_"+str(args.dataset)+"_topk_1000"+"_num_split_"+(str(20) if args.dataset == "sift1b" or args.dataset == "deep1b" else str(1))+"_batch_128_"+str(args.metric)+"_reorder_-1_sweep_result.txt"
...
new_file_location = recall_file_location
new_file_name = str(args.program)+"_"+str(args.dataset)+"_topk_1000"+"_num_split_"+(str(20) if args.dataset == "sift1b" or args.dataset == "deep1b" else str(1))+"_batch_128_"+str(args.metric)+"_reorder_-1_sweep_result_merged.txt"
